...
"""
import re
def pig_latin(word):# translated to pig latin by moving the first letter to the end, followed by "ay".
    if word.isalpha():
        word = word[1:] + word[0] + 'ay'
    return word

#text = """ Take a look, 2! at e26898. those: two GitHub profile timelines..."""
text_full= ''
